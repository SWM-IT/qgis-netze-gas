...
Die erstellen Packe kein ein Benutzer per *Geogig Package Reader* auf seinem System auspacken und hat ein fertig konfiguriertes System zur Hand.
...
Bevor Sie den *Geogig Package Creator* installieren, müssen Sie das *Vereinfachtes Geogig Plugin* sowie dess Voraussetzungen installieren (siehe Dokumentation GeogigLocalClient.rst).
...
Im Editfeld geben Sie den Pfad und den Dateinamen des zu erzeugend Paketes an. Mit dem Knopf an der rechten Seite öffnen Sie eine Dateiauswahlbox, mit der Sie das u.U. einfacher bewerkstelligen können.

Darunter gibt es vier Checkboxen, über die Sie steuern können, welche Komponenten das Paket enthalten soll. Standardmäßig sind all Boxen angehakt.
