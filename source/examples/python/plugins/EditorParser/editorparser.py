...
class EditorParser:
    ...
    def __init__(self, iface):
        ...
        self.dlg.DirectConvertProjectDataButton.clicked.connect(self.startDirectConvert) 
        
        # read smallworld page visibitiys from db               
        self.editor_visibility_layers = self.getSmallworldPageVisibility()
    ...
    def startDirectConvert(self):         
        ...
        reply = QMessageBox.question(None, "ACHTUNG:", "Es wird die aktuelle Projekdatei angepasst !", QMessageBox.Yes, QMessageBox.No)
                    ...
                    for visibilty in editor_visibility:   
                        ...
                        if layer_field_names.has_key(visibility_name):  
                            ...
                            if enum_name != None:
                                ...
                                enum_values = self.Connector.getEnumValues(enum_name)
                                ...
                                for edittype in edittypes_tag.iter('edittype'):
                                    ...
                                    if visibility_name == field_name:                                        
                                        ...
                                        Widgetv2ConfigAttributes = {"fieldEditable": "1", "constraint": "", "labelOnTop": "0", "constraintDescription": "", "notNull": "0"}
                                        
                                        # wieder neu mit standartwerten einfügen                                        
                                        child_edittpe = ET.SubElement(edittype, "widgetv2config",  Widgetv2ConfigAttributes)
                            ...
                            if page_name == "main_page":
                                ...
                                if page_name != store_page_name: 
                                    ...
                                    # make TAB Tag
                                    ContainerAttributes = {"name": external_page_name, "showLabel": "1",  "visibilityExpressionEnabled": "0", "visibilityExpression": "", "groupBox": "0", "columnCount": "1"}
                                    child = ET.SubElement(parent, "attributeEditorContainer", attrib=ContainerAttributes)
    ...
    def directConvertProcessData(self, layer, editor_visibility): 
        ...
        external_layer_name = self.Connector.getExternalLayername(layername)     
        ...
        for visibilty in editor_visibility: 
            ...
            if layer_field_names.has_key(visibility_name):  
                ...
                visibility_values = {"internal_fieldname": internal_fieldname, "page_name": page_name, "external_page_name": external_page_name, "external_fieldname": external_fieldname, "field_type": field_type, "enum_name": enum_name}
    ...
    def writeAliasesTags(self, idx, visibility_name, visibility_values, map_layer, doc):
        ...
        for i in range(0, nodes.size()):
            ...
            if visibility_name == field_value:      
                ...
                FieldAttributes = {"field": field_value, "index": str(idx), "name": visibility_values["external_fieldname"] }                    
    ...
    def getSmallworldPageVisibility(self):   
        ...
        for layer in projectLayers:
            ...
            visibility_properties = self.Connector.getVisibilitysFromDB(table_name)       
