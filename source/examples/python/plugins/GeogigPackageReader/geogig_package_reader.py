...
from geogig_package_reader_dialog import GeogigPackageReaderDialog
import os.path


class GeogigPackageReader:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'GeogigPackageReader_{}.qm'.format(locale))
        ...
        self.toolbar = self.iface.addToolBar(u'GeogigPackageReader')
        self.toolbar.setObjectName(u'GeogigPackageReader')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GeogigPackageReader', message)
    ...
    def initGui(self):
        ...
        self.add_action(
            "package_reader_24.png",
            text=self.tr(u'Open Package'),
            callback=self.run,
    ...
    def run(self):
        ...
        self.dlg.setVisible(not self.dlg.isVisible())
