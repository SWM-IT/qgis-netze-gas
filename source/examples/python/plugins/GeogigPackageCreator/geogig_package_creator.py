...
from geogig_package_creator_dialog import GeogigPackageCreatorDialog
import os.path


class GeogigPackageCreator:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'GeogigPackageCreator_{}.qm'.format(locale))
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GeogigPackageCreator', message)
